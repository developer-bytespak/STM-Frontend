    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-1 sm:right-2 top-1/2 transform -translate-y-1/2 bg-navy-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 text-sm sm:text-base rounded-md hover:bg-navy-700 transition-colors cursor-pointer"
        >
          Search
        </button>
      </div>
