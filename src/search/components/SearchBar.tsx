            ...
            <div className="flex flex-wrap gap-2">
              {popularServices.map((service) => (
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-gray-900 bg-gray-100 border border-gray-300 rounded-full hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-colors"
                >
                  {service}
                </button>
              ))}
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-4 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none bg-white text-lg"
              >
