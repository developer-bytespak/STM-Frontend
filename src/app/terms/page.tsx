        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              By accessing and using ServiceProStars, you accept and agree to be bound by the terms 
              and provision of this agreement. If you do not agree to abide by the above, please do 
              not use this service.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Use License</h2>
            <p className="text-gray-700 mb-4">Permission is granted to temporarily download one copy of ServiceProStars for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</p>
            ...
            <p className="text-gray-700 mb-6">
              ServiceProStars is a platform that connects customers with service providers. We facilitate 
            ...
            <p className="text-gray-700 mb-6">
              In no event shall ServiceProStars, nor its directors, employees, partners, agents, suppliers, 
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <p className="text-gray-700">
                <strong>Email:</strong> legal@serviceprostars.com<br />
